    ...
    (f = a("events", d).EventEmitter),
      ...
      (e = (function(d) {
        function a(d) {
          ...
          for (a in c)
            (b = c[a]),
              null != this.options[a] ? this.options[a] : (this.options[a] = b);
        }
        return (
          i(a, d),
          (c = {
            workerScript: window.envURL+"/gif.worker.js",
            workers: 2,
            repeat: 0,
            background: "#fff",
            quality: 10,
          ...
          (a.prototype.addFrame = function(a, d) {
            ...
            null == d && (d = {}),
              (c = {}),
              (c.transparent = this.options.transparent);
            ...
            if (
              ...
              d.copy ? (c.data = this.getImageData(a)) : (c.image = a);
                    ...
                    return function(c) {
                      ...
                      return (
                        ...
                        (b.onmessage = (function(a) {
                          return function(c) {
                            return (
                              a.activeWorkers.splice(
                                a.activeWorkers.indexOf(b),
                                1
                              ),
          ...
          (a.prototype.finishRendering = function() {
            ...
            (b += a.pageSize - a.cursor),
              console.log(
                "rendering finished - filesize " + Math.round(b / 1e3) + "kb"
              ),
              (e = new Uint8Array(b)),
              (d = 0);
          ...
          (a.prototype.getContextData = function(a) {
            return a.getImageData(0, 0, this.options.width, this.options.height)
              .data;
          }),
