    ...
    switch (type) {
        ...
        case TEMPLATE.LINE:
            return {
                data: mergeDataToDummy([
                    ['', '1분기', '2분기', '3분기', '4분기'],
                    ['2016년', '15.4', '11.5', '17.1', '28.7'],
                    ['2017년', '39.2', '45.6', '46.1', '49.5'],
                ]),
                emphasisTarget: [-1, -1, -1, -1],
                meta:{
                    title: 'SK하이닉스 분기별 실적 추이',
                    subtitle: '',
                    unit:'억원',
                    reference:'금융감독원',
                    madeBy: 'jiggle'
                ...
                paper:{
                    title: `[SK하이닉스 또 최대 실적…연이익 '10조 클럽' 예약`,
                    contents: `SK하이닉스가 올해 3분기 역대 최대 실적을 기록하면서 '연이익 10조 클럽'의 9부 능선을 넘었다. 글로벌 반도체시장 슈퍼호황의 결과다. 지난해 4분기부터 이어진 실적 개선세가 내년까지 이어질 것이라는 전망이 힘을 얻으면서 한차례 더 신기록 경신이 기대된다.`
                }
            }
